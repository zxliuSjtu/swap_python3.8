...
class LexBuildOptionTests(unittest.TestCase):
    ...
    def test_lex_optimize(self):
        ...
        self.assertTrue(check_expected(result,
                                    ...
                                    "(PLUS,'+',1,1)\n"
                                    "(NUMBER,4,1,2)\n"))
        self.assertTrue(os.path.exists("lextab.pyo"))
    ...
    def test_lex_optimize2(self):
        ...
        self.assertTrue(check_expected(result,
                                    ...
                                    "(PLUS,'+',1,1)\n"
                                    "(NUMBER,4,1,2)\n"))
        self.assertTrue(os.path.exists("opt2tab.pyo"))
        os.remove("opt2tab.pyo")
    ...
    def test_lex_optimize3(self):
        ...
        self.assertTrue(check_expected(result,
                                    ...
                                    "(PLUS,'+',1,1)\n"
                                    "(NUMBER,4,1,2)\n"))
        self.assertTrue(os.path.exists("lexdir/sub/calctab.pyo"))
    ...
    def test_lex_opt_alias(self):
        ...
        self.assertTrue(check_expected(result,
                                    ...
                                    "(+,'+',1,1)\n"
                                    "(NUMBER,4,1,2)\n"))
        self.assertTrue(os.path.exists("aliastab.pyo"))
        os.remove("aliastab.pyo")
    ...
    def test_lex_many_tokens(self):
        ...
        self.assertTrue(os.path.exists("manytab.pyo"))
        os.remove("manytab.pyo")
        try:
            os.remove("manytab.py")
        except OSError:
